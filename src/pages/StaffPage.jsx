...
import { ChevronLeft, UserPlus, ChevronDown, Calendar, FileText, ListTodo, MoreVertical, Save } from 'lucide-react';
        ...
        <div className="flex flex-col gap-6 pb-24">
            ...
            <div>
                <div className="flex items-center justify-between mb-4 mt-2">
                    <h2 className="font-bold text-emerald-900 text-lg">Chief Staff Permissions</h2>
                ...
                <div className="flex flex-col gap-3">
                    <PermissionCard
                        ...
                        onChange={() => togglePermission('bookings')}
                    />
                    <PermissionCard
                        icon={FileText}
                    ...
                    <PermissionCard
                        ...
                        onChange={() => togglePermission('tasks')}
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <PersonnelCard
                        name="Maya Devi"
                        joined="05 Feb 2024"
                        img="https://i.pravatar.cc/150?u=devi"
                    />
                </div>
            </div>
...
const PersonnelCard = ({ name, joined, img }) => (
    <div className="bg-white p-4 rounded-3xl shadow-sm flex items-center justify-between border border-gray-50">
        <div className="flex items-center gap-4">
            ...
            <div>
                ...
                <p className="text-xs text-gray-400 font-medium">Joined: {joined}</p>
            </div>
        </div>
